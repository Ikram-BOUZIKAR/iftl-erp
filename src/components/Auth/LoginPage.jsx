...
const FEATURES = [
  {
    ...
    label: 'Emplois du temps & planification',
  },
  {
    icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4',
    label: 'Émargement & suivi des présences',
  },
  {
    icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z',
    label: 'Gestion des apprenants & groupes',
  },
  {
  ...
  },
  {
    ...
    label: 'Facturation & suivi des paiements',
  },
  {
    icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z',
    label: 'Candidatures & inscriptions en ligne',
  },
];

const FILIERES = [
  { code: 'OTM', label: 'Opérateur Transport & Messagerie' },
  { code: 'OFLP', label: 'Opérateur Freight Logistique & Portuaire' },
  { code: 'AEL', label: 'Agent Exploitation Logistique' },
  { code: 'ECOM', label: 'E-Commerce & Commerce Électronique' },
  { code: 'ADEE', label: 'Agent Déclarant en Douane & Échanges Extérieurs' },
  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        ...
        />
        {/* Cercles */}
        <div className="absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full opacity-[0.07]" style={{ background: '#f5c845' }} />
        <div className="absolute top-1/2 -right-48 w-96 h-96 rounded-full opacity-[0.05]" style={{ background: '#c8d45d' }} />
        <div className="absolute -bottom-32 left-1/4 w-80 h-80 rounded-full opacity-[0.07]" style={{ background: '#f5c845' }} />

        {/* Logo */}
        <div className="relative flex items-center gap-4">
          <div
            className="w-13 h-13 rounded-2xl flex items-center justify-center shrink-0 shadow-lg"
            style={{ background: '#f5c845', width: 52, height: 52 }}
          >
            <span className="font-black text-sm tracking-tighter" style={{ color: '#005989', fontSize: 15 }}>IF</span>
          </div>
          <div>
            <p className="text-white font-black text-xl leading-none tracking-wider">IFTL</p>
            <p className="text-xs font-medium mt-1 leading-tight" style={{ color: 'rgba(245,200,69,0.85)' }}>
        ...
        <div className="relative space-y-8">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.6)' }}>
              Une solution intégrée pour gérer chaque dimension pédagogique, administrative et financière de votre formation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {STATS.map(s => (
              ...
              >
                ...
                <p className="text-xs mt-0.5 leading-tight" style={{ color: 'rgba(255,255,255,0.5)' }}>{s.label}</p>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-2.5">
            {FEATURES.map(f => (
              <div key={f.label} className="flex items-center gap-3">
                ...
                >
                  <Icon d={f.icon} className="w-3.5 h-3.5" style={{ color: '#f5c845' }} />
                </div>
                <span className="text-sm" style={{ color: 'rgba(255,255,255,0.72)' }}>{f.label}</span>
              </div>
            ))}
          </div>
        ...
        <div className="relative">
          ...
          >
            <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5" style={{ background: 'rgba(200,212,93,0.15)' }}>
              <Icon d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" className="w-4 h-4" style={{ color: '#c8d45d' }} />
            </div>
            <div>
              ...
              <p className="text-xs font-semibold mt-1" style={{ color: '#c8d45d' }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-start overflow-y-auto px-6 py-10 bg-slate-50 min-h-screen">
          ...
          {resetMode ? (
            <div>
              <button
                ...
                className="flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-700 transition mb-5"
              >
              ...
              {resetSent ? (
                ...
                >
                  ...
                  <p className="font-bold text-green-800 mb-1">Email envoyé</p>
                ...
                <>
                  ...
                  <form onSubmit={handleReset} className="space-y-4">
                    <Field label="Adresse email">
                      <div className="relative">
                        <div className="absolute inset-y-0 left-3.5 flex items-center pointer-events-none">
                          <Icon d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" className="w-4 h-4 text-slate-400" />
                        </div>
                        <input
                          type="email" required value={resetEmail}
                          onChange={e => setResetEmail(e.target.value)}
                          placeholder="vous@iftl.ma"
                          className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-xl bg-white text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-[#005989]"
                        />
                      </div>
                    </Field>
                    {error && (
                    ...
                    >
                      {resetLoading ? <Spinner /> : 'Envoyer le lien'}
                    </button>
                  </form>
                </>
              )}
            ...
            <>
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <Field label="Adresse email">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-xl bg-white text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-[#005989] transition"
                    />
                  </div>
                </Field>
                ...
                <Field label="Mot de passe">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-11 py-3 border border-slate-300 rounded-xl bg-white text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-[#005989] transition"
                    />
                    <button type="button" onClick={() => setShowPassword(v => !v)}
                      ...
                      {showPassword
                        ...
                        : <Icon d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" d2="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" className="w-4 h-4" />
                      }
                    </button>
                  </div>
                </Field>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button type="button" onClick={() => { setResetMode(true); setResetEmail(email); setError(''); }}
                    className="text-sm font-medium transition" style={{ color: '#005989' }}
                    onMouseEnter={e => e.target.style.color = '#004070'}
                    onMouseLeave={e => e.target.style.color = '#005989'}
                  >
                    Mot de passe oublié ?
                  </button>
                </div>
                ...
                {isPending && (
                  <Alert type="warning">
                    <strong>Compte en attente de validation.</strong> Un administrateur doit approuver votre accès avant de pouvoir vous connecter.
                  </Alert>
                )}
                ...
                >
                  {loading ? (
                    ...
                    <>
                      Se connecter
                      <Icon d="M13 7l5 5m0 0l-5 5m5-5H6" className="w-4 h-4" />
                    </>
                  )}
                </button>
              </form>
              ...
              <div className="space-y-2.5">
                ...
                >
                  <Icon d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" className="w-4 h-4 shrink-0" />
                  Créer un compte
                </Link>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <Link
                    to="/resultats"
                    className="flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl font-medium text-sm border bg-white hover:bg-slate-50 transition text-center"
                    style={{ borderColor: '#e2e8f0', color: '#64748b' }}
                  >
                    <Icon d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" className="w-3.5 h-3.5 shrink-0" />
                    Mes résultats
                  </Link>
                  <Link
                    to="/candidature"
                    ...
                    style={{ borderColor: '#e2e8f0', color: '#64748b' }}
                  >
                    <Icon d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" className="w-3.5 h-3.5 shrink-0" />
                    Candidater
                  </Link>
                </div>
              </div>
        ...
        <div className="hidden lg:block mt-8 text-center">
          <p className="text-xs text-slate-400">
            Loi n° 09-08 · Protection des données personnelles · Autorisation CNDP n° A-PO-268/2024
          </p>
        </div>
      </div>
    </div>
...
function Alert({ type, children }) {
  const styles = {
    error:   { bg: '#fef2f2', border: '#fecaca', color: '#c8141b', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z' },
    warning: { bg: '#fffbeb', border: '#fde68a', color: '#92400e', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  }[type];
  return (
    <div className="flex items-start gap-2.5 p-3.5 rounded-xl text-sm" style={{ background: styles.bg, border: `1px solid ${styles.border}`, color: styles.color }}>
