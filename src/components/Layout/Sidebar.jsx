...
const EXTRA_PATHS = {
  ...
  fc:           'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
};
...
const PATHS = {
  ...
  star:       'd="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"',
  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center shrink-0 h-14 border-b border-white/10 ${open ? 'px-4 gap-3' : 'justify-center'}`}>
        ...
        {!open && (
          <div className="w-9 h-9 rounded-lg overflow-hidden shrink-0 shadow-md bg-white flex items-center justify-center p-0.5">
            <img src="/Logo IFTL avec Signature.png" alt="IFTL" className="w-full h-full object-contain" />
          </div>
        )}
        {/* Logo étendu (expanded) */}
        {open && (
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[9px] leading-tight font-medium truncate" style={{ color: 'rgba(245,200,69,0.85)' }}>
